...
function showFinalScore(  )
    ...
    local finalScoreTextWidth, finalScoreTextHeght = gfx.getTextSize(finalScoreText)
    local finalScoreImage = gfx.image.new(finalScoreTextWidth, finalScoreTextHeght)
    
    gfx.pushContext(finalScoreImage)
        -- Wrapping the text with asterrisks makes the text bold
